...
public class MainController 
{
    ...
    public MainController(BillService billService, ItemService itemService, EmployeeService employeeService, IncomeService incomeService, ReportService reportService)
    {
